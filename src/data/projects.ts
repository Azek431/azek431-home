...
export const projectDetails: ProjectDetail[] = [
  {
    ...
    longDescription: '作为整个个人生态的入口站点，主站重点在设计系统、动效、玻璃质感和持续维护的稳定性。',
    status: '已上线',
    category: 'Website',
  ...
  },
  {
    ...
    longDescription: '一个以资料整理为核心的项目官网，使用 Cloudflare Pages 部署，GitHub + Gitee 双镜像同步。',
    status: '已上线',
    category: 'Docs',
  ...
  },
  {
    ...
    longDescription: '后续会作为独立仓库维护，从主站统一跳转。计划包含文章列表、标签分类、全文搜索、RSS。',
    status: '计划中',
    category: 'Blog',
  ...
  },
  {
    ...
    longDescription: '一个实验性项目，专门承载 AI 工具评测、提示词工程、自动化脚本和小模型部署等尝试。',
    status: '构想中',
    category: 'Lab',
